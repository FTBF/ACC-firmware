...
# ACDS 19.1 670 win32 2022.03.17.18:22:52
# ----------------------------------------
...
# ----------------------------------------
# If ETH_out_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "ETH_out_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ETH_out_pll.vho"
}
